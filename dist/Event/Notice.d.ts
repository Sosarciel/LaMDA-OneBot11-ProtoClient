...
/**任何通知事件数据 */
export type NoticeEventData = GroupUploadEventData | GroupAdminEventData | GroupDecreaseEventData | GroupIncreaseEventData | GroupBanEventData | FriendAddEventData | GroupRecallEventData | FriendRecallEventData | FriendPokeEventData | GroupPokeEventData | GroupLuckyKingEventData | GroupHonorEventData | GroupCardEventData | GroupTitleEventData | OfflineFileEventData | ClientStatusEventData | EssenceMessageEventData;
/**任何通知事件 */
export type NoticeEvent = GroupUploadEvent & GroupAdminEvent & GroupDecreaseEvent & GroupIncreaseEvent & GroupBanEvent & FriendAddEvent & GroupRecallEvent & FriendRecallEvent & FriendPokeEvent & GroupPokeEvent & GroupLuckyKingEvent & GroupHonorEvent & GroupCardEvent & GroupTitleEvent & OfflineFileEvent & ClientStatusEvent & EssenceMessageEvent;
