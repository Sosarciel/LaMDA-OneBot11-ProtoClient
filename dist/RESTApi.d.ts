...
/**任何动作的 响应数据 */
export type AnyActionRespData = SendPrivateMsgRespData | SendGroupMsgRespData | SendMsgRespData | GetMsgRespData | GetForwardMsgRespData | GetLoginInfoRespData | GetStrangerInfoRespData | GetFriendListRespData | GetGroupInfoRespData | GetGroupMemberInfoRespData | GetGroupHonorInfoRespData | GetCookiesRespData | GetCsrfTokenRespData | GetCredentialsRespData | GetRecordRespData | GetImageRespData | CanSendImageRespData | CanSendRecordRespData | GetStatusRespData | GetVersionInfoRespData;
/**基础响应 */
